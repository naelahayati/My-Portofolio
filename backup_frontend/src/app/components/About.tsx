...
export function About() {
  const features = [
    {
      icon: GraduationCap,
      title: 'Education',
      description: 'D3 Sistem Informasi - Semester 5',
  ...
  const stats = [
    { icon: Rocket, label: 'Projects', value: '15+', color: 'text-secondary' },
    { icon: Target, label: 'Skills', value: '20+', color: 'text-primary' },
    { icon: Zap, label: 'Experience', value: '2+ Years', color: 'text-accent' },
  ];
        ...
        >
          ...
          >
            <p className="text-center text-muted-foreground max-w-3xl mx-auto leading-relaxed text-lg">
              Saya adalah mahasiswa D3 Sistem Informasi semester 5 yang memiliki passion dalam pengembangan teknologi
              dan inovasi digital. Dengan fokus pada pembuatan solusi yang efektif dan user-friendly, saya terus
              mengembangkan kemampuan dalam berbagai teknologi web modern.
            </p>
